...
public class Adresse2Etablissement {
    ...
    public String getFullAdress() {
        return
                " " + (this.complementAdresse2Etablissement == null ? "" : this.complementAdresse2Etablissement) +
                " " + (this.numeroVoie2Etablissement == null ? "" : this.numeroVoie2Etablissement) +
                " " + (this.indiceRepetition2Etablissement == null ? "" : this.indiceRepetition2Etablissement) +
                " " + (this.typeVoie2Etablissement == null ? "" : this.typeVoie2Etablissement) +
                " " + (this.libelleVoie2Etablissement == null ? "" : this.libelleVoie2Etablissement) +
                " " + (this.codePostal2Etablissement == null ? "" : this.codePostal2Etablissement) +
                " " + (this.libelleCommune2Etablissement == null ? "" : this.libelleCommune2Etablissement) +
                " " + (this.libelleCommuneEtranger2Etablissement == null ? "" : this.libelleCommuneEtranger2Etablissement) +
                " " + (this.distributionSpeciale2Etablissement == null ? "" : this.distributionSpeciale2Etablissement) +
                " " + (this.codeCommune2Etablissement == null ? "" : this.codeCommune2Etablissement) +
                " " + (this.codeCedex2Etablissement == null ? "" : this.codeCedex2Etablissement) +
                " " + (this.libelleCedex2Etablissement == null ? "" : this.libelleCedex2Etablissement) +
                " " + (this.codePaysEtranger2Etablissement == null ? "" : this.codePaysEtranger2Etablissement) +
                " " + (this.libellePaysEtranger2Etablissement == null ? "" : this.libellePaysEtranger2Etablissement);
    }
}
